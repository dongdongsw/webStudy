...
public class MusicMain extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 * 		=> 자동 로그인 (Cookie...)
		 * 
		 * 	2. service()	=> 사용자가 요청시마다 호출
		 * 		= doGet()
		 * 		= doPost()
		 * 
		 *	3. destroy() : 새로고침 / 화면 이동 => 자동 메모리 회수
		 *		= 호출마다 초기화
		 *		= 단점 : Ajax => React Vue  
		 *	---------------------------------------------------
		 *	MVC => Back / Front
		...
		out.println("<html>");
			...
			out.println("<body>");
				...
				out.println("<p>");
				// btn-{ xs, sm, lg} 버튼 크기
				// btn-danger btn-info btn-sucess btn-warning
				...
				out.println("<input  type = button class=\"btn-xs btn-sucess\" value=sucess>");
				...
				out.println("<input  type = button class=\"btn-xs btn-default\" value=default><br><br>");
				...
				out.println("<input  type = button class=\"btn-sm btn-sucess\" value=sucess>");
				...
				out.println("<input  type = button class=\"btn-sm btn-default\" value=default><br><br>");
				...
				out.println("<input  type = button class=\"btn-lg btn-sucess\" value=sucess>");
				...
				out.println("<input  type = button class=\"btn-lg btn-default\" value=default>");
