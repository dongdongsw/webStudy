...
public class ReplyBoardDAO {
  ...
  <select id="boardTotalPage" resultType="int">
    ...
    */
  	...
  	/*
  	 <select id="boardReplyInfoData" resultType="ReplyBoardVO" parameterType="int">
	  ...
	  <insert id="boardReplyInsert" parameterType="ReplyBoardVO">
	  	...
	  	VALUES(rb_no_seq.nextval,#{name}, #{subject}, #{content}, #{pwd}, #{group_id}, #{group_step},
	  		#{group_tab},#{root},0)
	  </insert>
	  
	  <!-- UPDATE -->
	  <update id="boardDepthIncrement" parameterType="ReplyBoardVO">
	  	UPDATE replyboard SET
	  	depth=depth+1
	  	WHERE no = #{no}
	  </update>
	  ...
	  <update id="boardSCData" parameterType="string">
	  	UPDATE replyboard SET
